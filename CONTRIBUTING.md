...
# <SAMP> Contributing to CipherSky

<samp> **Thank you for considering contributing CipherSky! All types of contributions are welcome and appreciated.**
...
```bash
# Clone your fork
git clone https://github.com/YOUR-USERNAME/ciphersky.git

# Navigate to project directory
cd https://github.com/la-b-ib/CipherSky.git
